      ...
      {display.page === "payment" && (
        <div className={styles.payment}>
          <div className={styles.top}>
            <span>
              Make Deposit to your unique Fervor Finance Wallet Address below
            </span>
          </div>
