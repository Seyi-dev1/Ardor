    ...
    <div className={styles.main}>
      <div className={styles.top_con}>
        ...
        <div className={styles.Leaderboard_con}>
          ...
          <TestimonialText
            image={customer2}
            text="Being a top client of Fervor Finances, Trading has been a remarkable journey of financial growth and success. Their unparalleled market expertise and personalized strategies have consistently delivered exceptional results. In just under three years, my portfolio has experienced an impressive 40% increase in profits worth over $1m. The team's dedication to my financial goals and their ability to seize lucrative opportunities sets them apart in the trading and stocks industry. Partnering with Fervor finances Team has not only maximized my gains but also deepened my trust in their capabilities."
            name="John Forster"
